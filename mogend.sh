...
MACHINE_DIR="${PROJECT_DIR}/ExampleMagicalRecord/Models/CoreData/Private"
HUMAN_DIR="${PROJECT_DIR}/ExampleMagicalRecord/Models/CoreData"
INCLUDE_H="${PROJECT_DIR}/ExampleMagicalRecord/Models/ModelIncludes.h"
